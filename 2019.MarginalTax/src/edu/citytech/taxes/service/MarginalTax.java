...
public class MarginalTax implements ICalculate {
	...
	TaxRate[] taxRateForAll = {
			new TaxRate(rate = .10f, r1 =9700, r2 = 0, Status.SINGLE, year = 2019)
			,new TaxRate(rate = .12f, r1 =39475, r2 = 9700, Status.SINGLE, year = 2019)
			,new TaxRate(rate = .22f, r1 =84200, r2 = 39475, Status.SINGLE, year = 2019)
			,new TaxRate(rate = .24f, r1 =160725, r2 = 84200, Status.SINGLE, year = 2019)
			,new TaxRate(rate = .32f, r1 =204100, r2 = 160725, Status.SINGLE, year = 2019)
			,new TaxRate(rate = .35f, r1 =510000, r2 = 204100, Status.SINGLE, year = 2019)
			,new TaxRate(rate = .37f, r1 =99999999, r2 = 510000, Status.SINGLE, year = 2019)
						  
			,new TaxRate(rate = .10f, r1 =19400 , r2 = 0, Status.MARRIED, year = 2019)
			,new TaxRate(rate = .12f, r1 =78950, r2 = 19400 , Status.MARRIED, year = 2019)
			,new TaxRate(rate = .22f, r1 =168400 , r2 = 78950, Status.MARRIED, year = 2019)
			,new TaxRate(rate = .24f, r1 =321450, r2 = 168400, Status.MARRIED, year = 2019)
			,new TaxRate(rate = .32f, r1 =408200, r2 = 321450, Status.MARRIED, year = 2019)
			,new TaxRate(rate = .35f, r1 =612350, r2 = 408200, Status.MARRIED, year = 2019)
			,new TaxRate(rate = .37f, r1 =99999999, r2 = 612350, Status.MARRIED, year = 2019)

			,new TaxRate(rate = .10f, r1 =13850 , r2 = 0, Status.HEAD_OF_HOUSE_HOLD, year = 2019)
			,new TaxRate(rate = .12f, r1 =52850, r2 = 13850 , Status.HEAD_OF_HOUSE_HOLD, year = 2019)
			,new TaxRate(rate = .22f, r1 =84200 , r2 = 52850, Status.HEAD_OF_HOUSE_HOLD, year = 2019)
			,new TaxRate(rate = .24f, r1 =160000, r2 = 84200, Status.HEAD_OF_HOUSE_HOLD, year = 2019)
			,new TaxRate(rate = .32f, r1 =204100, r2 = 160000, Status.HEAD_OF_HOUSE_HOLD, year = 2019)
			,new TaxRate(rate = .35f, r1 =510300, r2 = 204100, Status.HEAD_OF_HOUSE_HOLD, year = 2019)
			,new TaxRate(rate = .37f, r1 =99999999, r2 = 510300, Status.HEAD_OF_HOUSE_HOLD, year = 2019)
...
//		salary = 150_000;
		  ...
		  TaxRate [] taxRates = Arrays.stream(taxRateForAll)
				  .filter(m -> m.status == status.SINGLE)
				  .toArray(TaxRate[]::new);
        
		  
		  while(salary > taxRates[i].r1 && year == 2019) {
			  float taxPaid = (taxRates[i].r1 - taxRates[i].r2) *taxRates[i].rate;
			  taxRates[i].taxPaid = taxPaid;
			  System.out.println(taxRates[i]);
			  i++;
			}
		
		float taxPaid = (salary - taxRates[i].r2)*taxRates[i].rate;
		taxRates[i].taxPaid = taxPaid;
	
				
		double totalPaid = Arrays.stream(taxRates)
