...
class TestMarried {
	...
	@Test
	@DisplayName("test for married people 900k") // generates name for test name is junit report
	void test() {
	...
	@Test
	@DisplayName("test for married people 1000k") // generates name for test name is junit report
	void test2() {
	...
	@Test
	@DisplayName("test for married people 10") // generates name for test name is junit report
	void test3() {
	...
	@Test
	@DisplayName("test for married people 150,000") // generates name for test name is junit report
	void test4() {
